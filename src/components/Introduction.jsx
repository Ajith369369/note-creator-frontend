    ...
    <>
      ...
      <div className="w-100 m-0 my-5 grid">
        <div className="grid-item d-flex justify-content-start align-items-center">
          ...
          <h4 className="ms-3">
            <span className="me-2 fw-bold">Project Management</span>
            <br />
        ...
        <div className="grid-item d-flex justify-content-start align-items-center">
          ...
          <h4 className="ms-3">
            <span className="me-2 fw-bold">Remember Everything</span>
            <br />
        ...
        <div className="grid-item d-flex justify-content-start align-items-center">
          ...
          <h4 className="ms-3">
            <span className="me-2 fw-bold">Find Things Fast</span>
            <br />
        ...
        <div className="grid-item d-flex justify-content-start align-items-center">
          ...
          <h4 className="ms-3">
            <span className="me-2 fw-bold">Your Information, Your Way</span>
            <br />
        ...
        <div className="grid-item d-flex justify-content-start align-items-center">
          ...
          <h4 className="ms-3">
            <span className="me-2 fw-bold">Capture Everything</span>
            <br />
        ...
        <div className="grid-item d-flex justify-content-start align-items-center">
          ...
          <h4 className="ms-3">
            <span className="me-2 fw-bold">Document Everything</span>
            <br />
        ...
        <div className="grid-item d-flex justify-content-start align-items-center">
          ...
          <h4 className="ms-3">
            <span className="me-2 fw-bold">Take Notes, Take Action</span>
            <br />
        ...
        <div className="grid-item d-flex justify-content-start align-items-center">
          ...
          <h4 className="ms-3">
            <span className="me-2 fw-bold">Safe And Synced</span>
            <br />
        ...
        <div className="grid-item d-flex justify-content-start align-items-center">
          ...
          <h4 className="ms-3">
            <span className="me-2 fw-bold">Search Made Easy</span>
            <br />
